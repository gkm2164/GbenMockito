...
/**
 * actual intercepting method class.
 */
public class MockyInterceptor {
  ...
  /**
   * making a delegate calls for a mocked method.
   *
   * @param mock mocked object
   * @param invokedMethod called method
   * @param arguments parameters given
   * @param matchers matchers found from matcher record
   * @return returned value.
   * @throws Throwable any exceptions thrown by the mock definition
   */
